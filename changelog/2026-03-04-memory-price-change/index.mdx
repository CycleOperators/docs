...
title: Understand How The New Protocol Memory Increases Impact Your Dapp
authors: [byron]
---

Memory Costs on ICP Are Changing, and you might be wondering "what does this mean for my cycle bill"?

CycleOps now includes a dedicated **Memory Price Change** view so teams can quickly understand the impact of the upcoming [ICP protocol memory pricing](https://nns.ic0.app/proposal/?u=qoctq-giaaa-aaaaa-aaaea-cai&proposal=140538) update.
