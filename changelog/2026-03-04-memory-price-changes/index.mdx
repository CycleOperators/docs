...
image: ./memory-price-changes-external.png
authors: [byron]
---

[![](./memory-price-changes-internal.png)](/changelog/memory-price-changes)

Memory costs on ICP are changing, and you might be thinking "what does this mean for my cycle bill"?

We were wondering the same thing, so we built a dedicated **Memory Price Change** view into CycleOps that teams can use to quickly understand the impact of the upcoming [ICP protocol memory pricing](https://nns.ic0.app/proposal/?u=qoctq-giaaa-aaaaa-aaaea-cai&proposal=140538) update.
...
## How to view your projected memory cost increase
