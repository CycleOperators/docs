...
title: "Mermaid Diagram Support in Docs"
date: 2026-03-02
summary: "Our docs now support Mermaid diagrams — flowcharts, sequence diagrams, ER diagrams, and more, right in Markdown."
authors: [jorgen]
---

We've added [Mermaid](https://mermaid.js.org/) diagram support to our documentation site. You can now embed rich, interactive diagrams directly in Markdown using fenced code blocks.

<!-- truncate -->

## What's supported

Here's a showcase of the diagram types you can now use:
...
Wrap your diagram code in a ` ```mermaid ` fenced code block in any Markdown file — docs or changelog. See the [Mermaid docs](https://mermaid.js.org/) for the full syntax reference.
