---
slug: canister-history-tracker 
title: Trace Every Change with Built‑In Canister History 
authors: [byron]
image: ./canister-history-tracker-external.png
---

[![](./canister-history-tracker-internal.png)](/changelog/canister-history-tracker)
...
## Kudos
Huge thanks to the **Research‑AG** team (shout‑out to Timo Hanke) for building the History Tracker service, and for their support during the integration.
